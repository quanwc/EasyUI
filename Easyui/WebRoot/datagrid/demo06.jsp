...
<html>
  <head>
	...
	<script type="text/javascript" src="datagrid/script06.js"></script>
	...
	<script type="text/javascript">
		function abc(){
			//$("#box").datagrid("deleteRow", 0);  //在页面删除第1行数据，不会删除数据库数据
			//$("#box").datagrid("checkAll");  //选择页面所有的行
  ...
  <body>
	...
	<!-- 右击onRowContextMenu事件触发后，会将该menu显示出来 -->
